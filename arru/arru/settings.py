"""
Django settings for arru project.
...
SECRET_KEY = 'c#a%!h+a=t2s@857rb*!-z6l0djprj+!h88i1*o-e!_na5h$3k'
...
MIDDLEWARE = [
    ...
    #'arru.middleware.LoginRequiredMiddleware',
]

ROOT_URLCONF = 'arru.urls'
...
WSGI_APPLICATION = 'arru.wsgi.application'
